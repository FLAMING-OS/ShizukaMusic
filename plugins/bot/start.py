        ...
        if name[0:3] == "sud":
            ...
            if await is_on_off(config.LOG):
                ...
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    f"{message.from_user.mention} has just started  Music bot to check <code>SUDOLIST</code>\n\n**USER ID:** {sender_id}\n**USER NAME:** {sender_name}",
                )
            return
        if name[0:3] == "lyr":
...
⚡️ __Searched Powered By {config.MUSIC_BOT_NAME}__"""
            ...
            if await is_on_off(config.LOG):
                ...
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    f"{message.from_user.mention} has just started  Music bot to check <code>VIDEO INFORMATION</code>\n\n**USER ID:** {sender_id}\n**USER NAME:** {sender_name}",
                )
    else:
        try:
        ...
        photo=f"https://te.legra.ph/file/aa281cde60227f2ed6cfc.png",
        caption=f"""**━━━━━━━━━━━━━━━━━━━━━━━━
...
┣★ 𝐂𝐡𝐚𝐭: [FRIENDSHIP GRP](https://t.me/friendshipforever431)
┗━━━━━━━━━━━━━━━━━┛
...
━━━━━━━━━━━━━━━━━━━━━━━━**""",
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "➕ ❰ ADD ME TO YOUR GROUP ❱ ➕", url=f"https://t.me/{app.username}?startgroup=true"),
                ],
                [
                    InlineKeyboardButton(
                        text="⚙ ❰ COMMANDS MENU ❱ ⚙", callback_data="settings_back_helper")
                ]
           ]
        ),
                  )

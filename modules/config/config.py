...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", " ShizukaMusic")
OWNER_ID = list(map(int, getenv("OWNER_ID", "").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/FLAMING-OS/ShizukaMusic",)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/friendsforever431")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/friendsforever431")
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/pan_kaj_0027")
...
START_IMG_URL = getenv("START_IMG_URL", f"https://te.legra.ph/file/aa281cde60227f2ed6cfc.jpg")

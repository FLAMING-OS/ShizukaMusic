...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("friendsforever431")
                await self.two.join_chat("friendsforever431")
                await self.two.join_chat("friendsforever431")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("friendsforever431")
                await self.three.join_chat("friendsforever431")
                await self.three.join_chat("friendsforever431")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("friendsforever431")
                await self.four.join_chat("friendsforever431")
                await self.four.join_chat("friendsforever431")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("friendsforever431")
                await self.five.join_chat("friendsforever431")
                await self.five.join_chat("friendsforever431")
            except:
                pass

...
async def init():
    ...
    LOGGER("SHIZUKA_PLAYER").info("Shizuka Player Bot Started Successfully")
    await idle()


if __name__ == "__main__":
    loop.run_until_complete(init())
    LOGGER("SHIZUKA_PLAYER").info("Stopping Shizuka Player Bot! GoodBye")
